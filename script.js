            ...
            children: {
                'projets': {
                    ...
                    children: {
                        ...
                        'mainframe-logs.txt': { type: 'file', content: 'Analyseur de logs pour mainframe\n\nDescription: Application d\'analyse de logs pour environnement Z/OS\nTechnologies: COBOL, mainframe\n\nProjet personnel (2025) en développement.' }
                    }
                },
                'competences': {
                    type: 'directory',
                ...
                'about.txt': { 
                    type: 'file', 
                    content: 'À propos de moi:\n\nJe suis étudiant en BTS CIEL (Cybersécurité, Informatique, ELectronique et réseaux) au Lycée Pilote Innovant International de Poitiers. Passionné par la cybersécurité, le développement logiciel et l\'intelligence artificielle, je développe constamment mes compétences à travers des projets personnels et professionnels.\n\nMes domaines d\'expertise incluent la programmation dans plusieurs langages (Python, C++, COBOL, PHP, JavaScript), les réseaux informatiques, et la cybersécurité.\n\nJe suis particulièrement intéressé par les défis de cybersécurité, comme en témoignent mes résultats aux compétitions CTF (Capture The Flag), où j\'ai obtenu de bons classements.' 
                }
            }
        }
    };
